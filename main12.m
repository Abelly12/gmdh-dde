...
function [y,bestfit,final]=main12(informations,N_pop,N_HL,pmm,N_Generation,N_Prediction,metofcal,first_seed,CR,F)

seed=ran2(first_seed); 
[Rinputs,Cinputs]=size(informations); 

for i=1:Cinputs-2
    xin(:,i)=informations(:,i+1);
end
y=informations(:,Cinputs);
y=y';
[qwe1,mnb]=size(xin);
